...
public class ItemPageController implements Initializable {
	...
	@FXML
	private JFXTreeTableColumn<ItemFX, String> idColumn = new JFXTreeTableColumn("ID");

	@FXML
	private JFXTreeTableColumn<ItemFX, String> nameColumn = new JFXTreeTableColumn("Item Name");;

	@FXML
	private JFXTreeTableColumn<ItemFX, String> unitColumn = new JFXTreeTableColumn("Unit");;
